...
public class Class246 extends Class397 {
   ...
   protected void cl(RoleData var1) {
      Goodstable var2;
      if ((var2 = var1.getPawnGood(this.j + this.ot())) != null) {
         ((Class270)this.lo.ve().e(47 & 126)).oj(var2, (boolean)(5 >> 3));
      }
   }
   ...
   public Class246(Class345 var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
   ...
   protected void cm(Graphics var1, RoleData var2) {
      ...
      for(int var10000 = var3 = 3 & 4; var10000 < this.asw.length; var10000 = var3) {
         ...
         Goodstable var6;
         if ((var6 = var2.getPawnGood(var4)) == null) {
            ...
            if (var7.asw[var3].k != null) {
               var1.drawString(this.asw[var3].k, var3 % this.cy * this.dp + --4, var3 / this.cy * this.gc + (62 & 79));
            }
            ...
            if (var6.getGoodlock() == (2 ^ 3)) {
               var1.drawImage(Class222.u, var3 % this.cy * this.dp + (127 & 36), var3 / this.cy * this.gc, 14 & 123, 93 & 46, (ImageObserver)null);
            }

            if (this.aeg && var4 == this.fk) {
               var1.setColor(Color.red);
               var1.drawRect(var3 % this.cy * this.dp + (2 ^ 3), var3 / this.cy * this.gc + (3 & 5), this.bn, this.m);
               var1.drawRect(var3 % this.cy * this.dp + (5 >> 1), var3 / this.cy * this.gc + --2, this.bn - (1 ^ 3), this.m - (5 >> 1));
               var1.setColor(Color.white);
            }
         }
