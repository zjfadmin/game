...
public class Class3 extends Class25 {
   @Override
   protected void am(RoleData var1) {
      Goodstable var2;
      if ((var2 = var1.getPawnGood(this.ia + this.dx())) != null) {
   ...
   public Class3(Class30 var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
   ...
   protected void ap(int var1, MouseEvent var2, RoleData var3) {
      ...
      if ((var4 = var3.getPawnGood(var1)) != null) {
         if (var3.getGoodPackSum(var4.getType(), var4.getGoodsid(), var4.getUsetime()) <= 0) {
            String var10001 = "伷胹卒巇溶";
            this.wd.afx.dp("你背包已满");
         } else {
            if (var3.ddGoodsList.remove(var4.getRgid())) {
               String var6 = Agreement.getSendTextAES("retrieve", var4.getRgid().toString());
               this.wd.za().k(var6);
            }
         }
      }
