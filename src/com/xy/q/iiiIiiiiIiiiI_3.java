...
extends IIiiIiiiiIIiI {
    protected void ALLATORIxDEMO(RoleData roleData) {
        Goodstable IiiiiiiiIIIII = roleData.getPawnGood(this.iiIIIiiiiiiiI + this.iiiIiiiiiiIIi());
    ...
    protected void ALLATORIxDEMO(Graphics graphics, RoleData roleData) {
        ...
        while (IiiiiiiiIIIII3 < this.iIiiIiiiiiiII.length) {
            ...
            if ((IiiiiiiiIIIII4 = roleData2.getPawnGood(IiiiiiiiIIIII2)) == null) {
    ...
    protected void ALLATORIxDEMO(int choseIndex, MouseEvent e, RoleData roleData) {
        Goodstable IiiiiiiiIIIII = roleData.getPawnGood(choseIndex);
        if (IiiiiiiiIIIII == null) {
            return;
        }
        ...
        if (!roleData.ddGoodsList.remove(IiiiiiiiIIIII.getRgid())) return;
        String IiiiiiiiIIIII2 = Agreement.getSendTextAES((String)"retrieve", (String)IiiiiiiiIIIII.getRgid().toString());
